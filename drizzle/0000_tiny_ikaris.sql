...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "arrangements_show_id_idx" ON "arrangements" USING btree ("show_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "files_show_id_idx" ON "files" USING btree ("show_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "files_arrangement_id_idx" ON "files" USING btree ("arrangement_id");

-- Custom SQL for `updated_at` trigger
