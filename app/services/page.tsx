  ...
  return (
    <div className="min-h-screen p-8">
      <div className="container mx-auto">
        <h1 className="text-5xl font-bold mb-6 font-primary text-bright-dark text-center">Our Services</h1>
        <p className="text-lg max-w-2xl mx-auto mb-12 text-gray-600 text-center">
