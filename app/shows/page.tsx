import { ArrowRight, Filter, Play, Music, Users, Star, Search, ArrowLeft } from "lucide-react"
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold mb-4 text-bright-dark font-primary">Complete Shows</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore our collection of award-winning complete marching band shows. Each show combines multiple
              arrangements into a cohesive, competition-ready performance.
            </p>
          </div>
              ...
              >
                ...
                <CardContent>
                  ...
                  <Button className="btn-primary w-full" asChild>
                    <Link href={`/shows/${show.id}`}>View Show Details</Link>
                  </Button>
                </CardContent>
              </Card>
            ))}
